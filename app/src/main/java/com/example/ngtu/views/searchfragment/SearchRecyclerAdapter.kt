...
import com.example.ngtu.databinding.ProductSearchItemBinding
...
class SearchRecyclerAdapter : RecyclerView.Adapter<SearchRecyclerAdapter.Holder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Holder {
        val binding =
            ProductSearchItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    inner class Holder(private val binding: ProductSearchItemBinding) :
